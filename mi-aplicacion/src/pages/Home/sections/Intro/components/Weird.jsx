...
//                 <div className="weird-navigation">
//                     {weirdItems.map((item, index) => (
//                         <div
//                             key={item.id}
//                             className={`weird-nav-item ${activeItemIndex === index ? 'active' : ''} ${item.lightText ? 'light-text' : 'dark-text'}`}
...
//                                         ? `conic-gradient(${item.lightText ? 'var(--light-color)' : 'var(--dark-color)'} ${progress * 3.6}deg, transparent ${progress * 3.6}deg)`
//                                         : 'transparent',
//                                     borderColor: item.lightText ? 'var(--light-color)' : 'var(--dark-color)'
//                                 }}
//                             ></div>
//                             {t(item.labelKey)}
//                         </div>
